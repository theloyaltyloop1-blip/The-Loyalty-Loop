      ...
      <main id="main-content">
        <section className="ll-hero ll-wrap">
          ...
          <div className="ll-card-scene">
            ...
            <div className="ll-paper-card">
              ...
              <p className="ll-card-subtitle">Spend £20. One coffee on the house.</p>
              <div className="ll-stamps" aria-label="Example loyalty card: £14 of £20 spent">{Array.from({ length: 10 }, (_, i) => <span key={i} className={i < 7 ? 'll-stamp ll-stamped' : 'll-stamp'} aria-hidden="true">{i < 7 ? <Check size={24} strokeWidth={1.5} /> : `£${(i + 1) * 2}`}</span>)}</div>
              <div className="ll-card-bottom"><span>£14 spent</span><span>£6 to your next coffee</span></div>
            </div>
        ...
        <section id="how-it-works" className="ll-how ll-wrap">
          ...
          <div className="ll-steps">{[
            ...
            ['02', 'Show your code.', 'At the till, show your QR code or short code. What you spend counts towards your reward.'],
        ...
        <section id="business" className="ll-business"><div className="ll-wrap ll-business-grid">
          ...
          <div className="ll-business-copy"><p>You know their order. We help you reward what they spend.</p><p>Choose rewards and how much customers spend to unlock them, record purchases from your phone, and see how your loyalty programme is doing. No paper cards to print or extra scanner to buy.</p><ul><li>Your shop. Your rewards.</li><li>Rewards that unlock as customers spend.</li><li>A shared workspace for owners and staff.</li></ul><Link className="ll-text-link" to="/login">Already have a business account? Log in <ArrowUpRight size={16} aria-hidden="true" /></Link></div>
        </div></section>

  ...
  return <OwnerLayout>
    ...
    {!business ? <div className="rounded-2xl bg-card p-8 text-center text-foreground/55">Set up your shop before publishing announcements.</div> : <>
      <form onSubmit={publish} className="rounded-2xl bg-card p-6 shadow-[0_1px_3px_rgba(0,0,0,0.08)] mb-7">
        ...
        <button disabled={publishing} className="mt-4 inline-flex items-center gap-2 rounded-xl bg-primary text-white px-5 py-3 font-bold disabled:opacity-60"><Plus className="h-4 w-4" />{publishing ? 'Publishing…' : 'Publish update'}</button>
      </form>

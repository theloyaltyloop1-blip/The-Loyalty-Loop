...
type CardData = {
  ...
  firstName: string
  appUrl: string
  memberships: Array<{ stamp_count: number; points_balance: number; visit_count: number; reward_progress_pence?: number | null; business: { name: string; loyalty_type: 'stamp_card' | 'points' | 'tiered' } | null }>
}
